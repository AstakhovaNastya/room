...
function initSlick() {
	jQuery('.slick-center').slick({
		...
		slidesToShow: 1,
		slidesToScroll: 1,
		prevArrow: '<button type="button" class="prev"><span class="icon-chevron-thin-left"></span></button>',
		nextArrow: '<button type="button" class="next"><span class="icon-chevron-thin-right"></span></button>'
	});
}
